...
\begin{flushleft}
  \textbf{Lühikokkuvõte:} Seadmedraiverite ehk ohjurite paralleelne olemus muudab nendest vigade leidmise inimiese jaoks väga keeruliseks.
  Staatiline analüsaator Goblint üritab automaatselt verifitseerida andmejooksude puudumist ohjuris. Sealjuures on suureks väljakutseks analüüsi täpsus.
  Käesolev töö pakkub välja edasiarenduse Goblinti regiooni analüüsile mis võimaldab võtta arvesse valdkonna spetsiifilisi \textit{happens-before} garantiisid.
  Väljapakutud täiendus on implementeeritud ning muudatuste mõju analüüsitud Linuxi ohjurite alamhulga peal.
  Me näitame et mainitud edasiarendus tõstab Goblinti täpsust \textit{character} tüüpi ohjurite analüüsimisel.
\end{flushleft}
\vspace*{3ex}

\begin{flushleft}
  \textbf{Võtmesõnad:} Paralleelsus, andmejooks, abstraktne interpertatsioon, seadmedraiverid, ohjurid, Goblint
\end{flushleft}
\vspace*{3ex}
