...
\begin{figure}[H]
 ...
 \begin{tabular}{|c|c|c|c|c| }
   ...
   \hline
   Driver & Indirect before & Indirect after & Direct before & Direct after \\ 
   \hline
...
In most of the drivers the effect can be attributed to the exclusion of races between \inlinecode{init} and \inlinecode{exit} functions. 
