...
the analyses must be able to answer the query based on the current context. This allows analyses to avoid duplication and allows one to design more modular analyses consitnig of subanalalyses.More regarding the query system of Goblint can be found here \toadd{Cite Kalmer}.
...
The partitioning of memory in a such way is done in Goblint by the region analyses. More informatino regarding the ideas used can be found ... \toadd{Cite Vesal}
